// $ANTLR 2.7.4: "quasi.g" -> "QuasiLexer.java"$
...
public class QuasiLexer extends antlr.CharScanner implements quasiTokenTypes, TokenStream
 {
...
tryAgain:
	...
	public final void mDOLLARESC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = DOLLARESC;
		int _saveIndex;
	...
	public final void mQUASICLOSE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = QUASICLOSE;
		int _saveIndex;
	...
	public final void mQIDENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = QIDENT;
		int _saveIndex;
	...
	public final void mQINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = QINT;
		int _saveIndex;
	...
	private static final long[] mk_tokenSet_1() {
		long[] data = { 287948901175001088L, 1152921498567049214L, 0L, 0L};
		return data;
	}
