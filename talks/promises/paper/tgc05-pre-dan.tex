...
%
     ...
     to distinguish among the sets \name{P} relies on for different
...
against} \name{Q} if \name{P} remains correct despite any of the
effects in \name{Q}'s relevant authority, that is, despite any
...
The \meth{\_\_whenMoreResolved} message can be used to be notified
...
the \code{if} is postponed until we've gathered enough information to
